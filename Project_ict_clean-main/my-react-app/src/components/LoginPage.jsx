  ...
  return (
    <div className="login-page-wrapper">
      <div className="login-card">
        ...
        {/* 🧪 บัญชีสำหรับทดสอบระบบ (Demo & Manual Test Accounts) */}
        <div style={{
          marginTop: '20px',
          padding: '14px',
          ...
          <div style={{ fontSize: '12px', fontWeight: '700', color: '#475569', marginBottom: '8px', display: 'flex', alignItems: 'center', gap: '5px' }}>
            <span>🧪 บัญชีสำหรับทดสอบระบบ (คลิกเพื่อกรอกอัตโนมัติ):</span>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '6px' }}>
            <button
              type="button"
              onClick={() => { setEmail('admin.ict@up.ac.th'); setPassword('password123'); }}
              style={{
                padding: '6px 8px',
                fontSize: '11px',
                borderRadius: '6px',
              ...
              title="สิทธิ์ผู้ดูแลระบบ (Admin Console, ตรวจจับผลงานซ้ำ, เบิกจ่าย)"
            >
              👑 Admin (ผู้ดูแลระบบ)
            </button>
            <button
              type="button"
              onClick={() => { setEmail('ratanapat.su@up.ac.th'); setPassword('password123'); }}
              style={{
                padding: '6px 8px',
                fontSize: '11px',
                borderRadius: '6px',
              ...
              title="ผศ. รตนพรรษ สุชาติ (มี Scholar ID & Scopus ID)"
            >
              👨‍🏫 ผศ. รตนพรรษ (อาจารย์ 1)
            </button>
            <button
              type="button"
              onClick={() => { setEmail('nakharet.ch@up.ac.th'); setPassword('password123'); }}
              style={{
                padding: '6px 8px',
                fontSize: '11px',
                borderRadius: '6px',
              ...
              title="ผศ. นคเรศ ชัยแก้ว (ผู้ร่วมวิจัย Co-Author)"
            >
              👩‍🏫 ผศ. นคเรศ (Co-Author)
            </button>
            <button
              type="button"
              onClick={() => { setEmail('suleeporn.ka@up.ac.th'); setPassword('password123'); }}
              style={{
                padding: '6px 8px',
                fontSize: '11px',
                borderRadius: '6px',
              ...
              title="ผศ. ศุลีพร คำชมภู (ผู้ร่วมวิจัย Co-Author)"
            >
              🧑‍🏫 ผศ. ศุลีพร (Co-Author)
            </button>
          </div>
          <div style={{ fontSize: '10.5px', color: '#94a3b8', marginTop: '6px', textAlign: 'center' }}>
            *รหัสผ่านสำหรับทุกบัญชี: <code>password123</code> (หรือรหัสผ่านใดก็ได้)
          </div>
        </div>
