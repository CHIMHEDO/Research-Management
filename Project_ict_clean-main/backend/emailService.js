...
async function sendCoAuthorConfirmationEmail({ toEmail, recipientName, submitterName, paperTitle, submitterProportion, authorList, frontendUrl }) {
  ...
  const htmlContent = `
    ...
    <body>
      <div class="card">
        <div class="header">
          <h2>ระบบเครื่องมือช่วยจัดการและวิเคราะห์ข้อมูลภาระงานวิจัย (AMS)</h2>
        ...
        <div class="content">
          ...
          <p style="font-size: 13px; color: #475569;">ขอความอนุเคราะห์ ท่านเข้าสู่ระบบเพื่อตรวจสอบ และยืนยันความถูกต้องของสัดส่วนภาระงานของท่าน สำหรับการนำไปใช้เป็นข้อมูลในการประเมินภาระงานทางวิชาการต่อไป กรณีที่ท่านไม่ประสงค์แก้ไขสัดส่วนภาระงาน ระบบจะทำการบันทึกสัดส่วนภาระงานโดยอัตโนมัติ ภายใน 7 วันนับจากวันที่ได้รับอีเมลฉบับนี้ กรณีที่ท่านประสงค์แก้ไขสัดส่วนภาระงาน ท่านสามารถดำเนินการได้ตามขั้นตอน ดังนี้ เข้าสู่ระบบด้วยบัญชีของท่าน ดำเนินการแก้ไขสัดส่วนผลงานวิชาการที่ต้องการปรับเปลี่ยน หมายเหตุ: เมื่อมีการแก้ไขสัดส่วนผลงานวิชาการใดๆ ระบบจะรีเซ็ตสถานะการยืนยันของผลงานวิชาการดังกล่าวโดยอัตโนมัติ เพื่อให้สมาชิกทุกท่านที่เกี่ยวข้องดำเนินการยืนยันใหม่อีกครั้ง ผลงานวิชาการจะถือว่าสมบูรณ์เมื่อสมาชิกทุกท่านได้ยืนยันครบถ้วนแล้ว และไม่มีการแก้ไขเพิ่มเติมใดๆ หรือเมื่อพ้นกำหนด 7 วันโดยไม่มีการแก้ไข ระบบจะบันทึกข้อมูลโดยอัตโนมัติ จึงเรียนมาเพื่อโปรดทราบและดำเนินการตามกำหนดเวลาที่ระบุ ขอแสดงความนับถือ</p>
  ...
  try {
    const info = await transporter.sendMail({
      from: `"ระบบเครื่องมือช่วยจัดการและวิเคราะห์ข้อมูลภาระงานวิจัย ICT UP" <${fromEmail}>`,
      to: toEmail,
